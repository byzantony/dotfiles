...
alias zconfigcode='zed ~/.zshrc' # Edit .zshrc in Zed
alias nvimconfig='nvim ~/.config/nvim/init.lua' # Edit init.lua in Neovim
alias wezconfig='nvim ~/.config/wezterm/wezterm.lua' # Edit .wezterm.lua
...
alias pilgrim='mosh shinjuru-vps.trex-scala.ts.net' # Shinjiru VPS login on Tailnet

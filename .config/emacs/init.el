...
(use-package citar
  ...
  :bind
  (("C-c w c" . citar-insert-citation)
  ("C-c w z" . citar-open-entry-in-zotero)
...
;; ==================================================
;; 11. ADVANCED UNDOCUMENTED EXPORT SETTINGS FOR EWS
;; ==================================================
...
;; Nerd Icons - required for modern icon support
(use-package nerd-icons
  :ensure t
  :config
  ;; Optional: Explicitly set the font family (recommended for consistency)
  ;; (setq nerd-icons-font-family "Symbols Nerd Font Mono")
  )

;; Dashboard configuration with proper nerd-icons integration
(use-package dashboard
  :ensure t
  :init
  (dashboard-setup-startup-hook)   ; Enable dashboard at Emacs startup
  :config
  ;; General appearance and behavior
  (setq dashboard-banner-logo-title "Emacs Writing Studio")
  (setq dashboard-center-content t)        ; Center the content
  (setq dashboard-set-heading-icons t)     ; Show icons for section headings
  (setq dashboard-set-file-icons t)        ; Show file icons

  (setq dashboard-footer-messages '("Focused writing environment ready."))
  (setq dashboard-projects-backend 'projectile)

  ;; Crucial settings for nerd-icons support
  (setq dashboard-display-icons-p t)       ; Enable icons in GUI and terminal
  (setq dashboard-icon-type 'nerd-icons)   ; Use nerd-icons instead of all-the-icons

  ;; Sections to display (5 recent files, 5 projects, 5 agenda items)
